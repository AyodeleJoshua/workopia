...
class ListingController
{
  ...
  public function destroy($params)
  {
    ...
    if (!Authorization::isOwner($listings->user_id)) {
      Session::setFlashMessage('error_message', 'You are not autorized to delete this listing');
      return redirect('/listing/' . $listings->$id);
    }
  ...
  public function edit($params)
  {
    ...
    if (!Authorization::isOwner($listing->user_id)) {
      Session::setFlashMessage('error_message', 'You are not autorized to update this listing');
  ...
  {
    $keywords = isset($_GET['keywords']) ? trim($_GET['keyweords']) : '';
    ...
    $listings = $this->db->query($query, ['keywords' => "%{$keywords}%", 'location' => "%{$location}%"])->fetchAll();
